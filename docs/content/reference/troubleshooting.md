...
Most of these come down to network reality or how dbengines serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

dbengines rate-limits like any public site. dbe already paces
...
Where a surface is gated, dbe reads a cookie or token you supply
...
`dbe`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what dbe actually did
